...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand"><img style="width: 60%" src="http://localhost/images/esig.png"></a>
        ...
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Central">
                <a class="nav-link" href="{{ URL::to('products') }}">
                    ...
                    <span class="nav-link-text">Listar Produtos</span>
                </a>
            </li>

            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Times">
                <a class="nav-link" href="{{ URL::to('products/create') }}">
                    <i class="fa fa-fw fa-address-book"></i>
                    <span class="nav-link-text">Adicionar Produtos</span>
                </a>
            </li>
        </ul>
